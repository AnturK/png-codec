...
describe('PngSuite', () => {
  ...
  describe('Transparency', () => {
    createTests([
      ...
      ['tbbn2c16', 'transparent, blue background chunk [converted to 8 bit]', { forceBitDepth8: true, customFile: 'tbbn2c16_to8' }],
      ['tbbn3p08', 'transparent, black background chunk'],
      ['tbgn2c16', 'transparent, green background chunk'],
      ['tbgn2c16', 'transparent, green background chunk [converted to 8 bit]', { forceBitDepth8: true, customFile: 'tbgn2c16_to8' }],
      ['tbgn3p08', 'transparent, light-gray background chunk'],
      ['tbrn2c08', 'transparent, red background chunk'],
      ['tbwn0g16', 'transparent, white background chunk'],
      ['tbwn0g16', 'transparent, white background chunk [converted to 8 bit]', { forceBitDepth8: true, customFile: 'tbwn0g16_to8' }],
